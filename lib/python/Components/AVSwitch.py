...
def InitAVSwitch():
	...
	if iAVSwitch.supports1080p:
		conv_60 = ["720p", "1080p", "1080i", "480p", "480i"]
		conv_50 = ["720p50", "1080p50", "1080ip50", "576p", "576i"] + conv_60
	else:
		conv_60 = ["720p", "1080i", "480p", "480i"]
		conv_50 = ["720p50", "1080i50", "576p", "576i"] + conv_60
